...
import MockedUserConsentProvider from '~jest/MockedUserConsentProvider'
  ...
  beforeEach(() => {
    ...
    render(
      <SdkOptionsProvider options={defaultOptions}>
        <MockedUserConsentProvider onGrantConsents={mockGrantConsents}>
          <MockedLocalised>
            <UserConsent {...defaultProps} />
          </MockedLocalised>
        </MockedUserConsentProvider>
      </SdkOptionsProvider>
    )
  })
