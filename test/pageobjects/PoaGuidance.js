...
class PoaGuidance extends BasePage {
  async poaGuidanceSubtitle() { return this.$('.onfido-sdk-ui-ProofOfAddress-Guidance-subTitle')}
  async makeSure() { return this.$('.onfido-sdk-ui-ProofOfAddress-Guidance-makeSure')}
  async logoText() { return this.$('.onfido-sdk-ui-ProofOfAddress-Guidance-label:nth-child(7)')}
  async fullNameText() { return this.$('.onfido-sdk-ui-ProofOfAddress-Guidance-label:nth-child(1)')}
  async currentText() { return this.$('.onfido-sdk-ui-ProofOfAddress-Guidance-label:nth-child(2)')}
  ...
  async benefitsLetterIcon() { return this.$('li:nth-child(4) .onfido-sdk-ui-DocumentSelector-icon')}
